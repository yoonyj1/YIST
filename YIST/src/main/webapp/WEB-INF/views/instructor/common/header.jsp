...
<body class="navbar-fixed sidebar-fixed" id="body">
	...
	<script>
		...
		function onMessage(evt) {
			...
			setTimeout(seletInsAlarmList, 300); 
		};
			...
			$.ajax({
				...
				success:function(alarmList){
					...
					if(alarmList == null){
						...
						$("#all-panel").append(allMsg);
						$("#task-panel").append(taskMsg);
						$("#exam-panel").append(examMsg);
						
						// 전체 알림수
						$("#all-tabs").html("알림(" + (taskCount + examCount) + ")");
	...
	<aside class="left-sidebar sidebar-light" id="left-sidebar">
		<div id="sidebar" class="sidebar sidebar-with-footer">
			...
			<div class="app-brand">
				<a
					href="${pageContext.request.contextPath}/resources/instructor/main.jsp">
					<img
			...
			<div class="sidebar-left" data-simplebar style="height: 100%;">
				...
				<ul class="nav sidebar-inner" id="sidebar-menu">
					...
					<li class="sider"><a class="sidenav-item-link"
						href="teacher.ins"> <i class="mdi mdi-account-group"></i> <span
							class="nav-text">강사</span>
					</a></li>
					...
					<li><a class="sidenav-item-link" href="gradeForm.ins"> <i
							class="mdi mdi-format-annotation-plus"></i> <span
							class="nav-text">성적</span>
					</a></li>
						...
						<div class="dropdown-notify">
							...
							<header>
								<div class="nav nav-underline" id="nav-tab" role="tablist">
									<!-- <a class="nav-item nav-link active" id="all-tabs" data-toggle="tab" href="" role="tab" aria-controls="nav-home" aria-selected="true"></a>  -->
									<a class="msg-count nav-item nav-link" id="all-tabs" data-toggle="tab" href="" role="tab" aria-controls="nav-profile" aria-selected="false">과제(3)</a> 
									<!-- <a class="nav-item nav-link" id="exam-tab" data-toggle="tab" href="#other" role="tab" aria-controls="nav-contact" aria-selected="false">시험(2)</a> -->
								</div>
							</header>
							...
							<div class="" data-simplebar style="height: 325px;">
								<div class="tab-content" id="myTabContent">
									...
									<!-- 전체 알람 -->
									<div class="msg-pane tab-pane fade alarm-tab show active" id="all-panel"
										role="tabpanel" aria-labelledby="all-tabs">
									</div>
									

<!-- 									과제 알람
									<div class="tab-pane fade alarm-tab" id="task-panel" role="tabpanel"
										aria-labelledby="message-tab">

									</div>
									
									시험 알람	
									<div class="tab-pane fade alarm-tab" id="exam-panell" role="tabpanel"
	...
	<script
		src="${pageContext.request.contextPath}/resources/instructor/js/mono.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/instructor/js/chart.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/instructor/js/map.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/instructor/js/custom.js"></script>
</body>
</html>
