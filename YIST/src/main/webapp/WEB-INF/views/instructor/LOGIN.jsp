	...
	<div class="contents">
        ...
        <div class="logincell" align="center">
           <div class="id_password" align="center">
            <br><br>
                            아이디&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="id" name="id" onkeypress="f_login();" placeholder="아이디 (*이메일 형식 입력불가)" autofocus="">
                            <br>
                            비밀번호 <input type="password" id="password" name="password" onkeypress="f_login();" placeholder="비밀번호" style="margin-top:8px;">
                            <br>
                            <a href=""><button class="gbtn">로그인</button></a>
                        </div>
                        <br>
                        <ul align="center">
