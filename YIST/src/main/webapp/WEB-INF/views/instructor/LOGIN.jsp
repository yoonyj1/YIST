	...
	<div class="contents" align="center">
		...
		<form action="login.me" method="post">
			<div class="id_password" align="center">
				<br>
				<br> 아이디&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="id"
					name="id" onkeypress="f_login();" placeholder="아이디 (*이메일 형식 입력불가)"
					autofocus=""> <br> 비밀번호 <input type="password"
					id="pwd" name="pwd" onkeypress="f_login();"
					placeholder="비밀번호" style="margin-top: 8px;"> <br> <a
					href="">
				   <button class="btn btn-primary" type="submit">로그인</button></a>
			</div>
			<br>
			<ul align="center">
