      ...
      <table>
          ...
          <tr>
            ...
            <td style="text-align: left;" colspan="2">
              ...
              <button type="button" class="common_btn2" id="" style="font-size: 14px; height: 35px; margin-left: 5px;">인증하기</button><br>
            </td>
          </tr>
          <tr>
            <th>이메일 주소</th>
          ...
          <tr>
            ...
            <td style="text-align: left;" colspan="2">
              ...
              <button type="button" class="common_btn2" id="findAddress" style="font-size: 14px; height: 35px; margin-left: 5px;" onclick="fnFindAddress();">주소검색</button><br>
