	      ...
	      <table>
	          <tr style="border-top: 1px solid black;">
				...
				<tr>
				  ...
				  <td style="text-align: left;">
				    <input type="password" class="form-control" id="pwd" name="pwd" value="${ loginUser.pwd }" placeholder="8 ~ 15 자의 영문 대소문자, 숫자, 특수문자를 조합하여 설정해 주세요." oninput="validatePassword();">
				...
				<tr>
				  <th>비밀번호 확인*</th>
				  <td style="text-align: left;">
				    <input type="password" class="form-control" id="confirmPassword" name="confirmPassword" value="${ loginUser.pwd }" placeholder="입력한 비밀번호와 동일한 비밀번호를 입력하세요." oninput="validatePassword();">
			...
			<tr>
	          ...
	          <tr>
	            <th>주소</th>
	            <td style="text-align: left;" colspan="2">
	              <input type="text" id="post" name="post" value="${ loginUser.post }" style="width: 61%;">
	              ...
	              <input type="text" id="address" name="address" value="${ loginUser.address }" style="width: 61%; margin-top:5px;"><br>
	              <input type="text" id="detailAddress" name="detailAddress" value="${ loginUser.detailAddress }" style="width:61%; margin-top:5px;" >
	              </td>
	          </tr>
	        </tbody>
	      </table>
